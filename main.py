...
<body>
                                ...
                                <div class="card mb-4 rounded-3 shadow-sm">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="collapse" id="collapseExample3">
                                            <div class="card card-body">
                                                На любой товар, купленный в России физическим лицом, распространяется обязательная гарантия 2 года
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    def do_GET(self):
        ...
        page_content = self.__get__content()
